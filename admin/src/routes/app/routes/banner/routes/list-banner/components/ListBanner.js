                ...
                <QueueAnim type="bottom" className="ui-animate">
                    <article className="article">
                        <div className="article-control">
                            <h2 className="article-title">KCoin Address</h2>
                        ...
                        <Table fixedHeader={true}>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHeaderColumn>User Relate</TableHeaderColumn>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {
                                    this.state.pageOfItems.map((item, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableRowColumn>{item.label + '@gmail.com'}</TableRowColumn>
                                        </TableRow>
                                    ))
                                }
                            </TableBody>
...
export default connect(mapStateToProps, { itemsFetchData })(ListBanner);